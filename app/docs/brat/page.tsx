...
export default function BratDocPage() {
        ...
        >
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <h1 className="text-3xl font-bold tracking-tight">Brat API Documentation</h1>
              <Badge variant="outline" className="ml-2">
                v1
              </Badge>
            </div>
            <p className="text-muted-foreground">
              Generate images based on text input with our simple and secure Brat API.
            </p>
          </div>
          ...
          <section id="overview" className={activeSection === "overview" ? "block" : "hidden"}>
            <div className="space-y-4">
              ...
              <p>
                The <strong>Brat API</strong> is a simple Next.js API route that fetches an image from an external API
                ...
                <div className="border rounded-lg p-4 bg-card">
                  ...
                  <div className="relative">
                    <code className="text-xs block bg-muted p-2 rounded overflow-x-auto whitespace-pre-wrap break-all">
                      https://api.vtxgroup.my.id/api/v1/brat?text=Love
                    </code>
                  </div>
                </div>
              </div>
          ...
          <section id="endpoint" className={activeSection === "endpoint" ? "block" : "hidden"}>
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold">GET /brat</h3>
                <div className="space-y-2">
                  <h4 className="text-lg font-medium">Description</h4>
                  <p>Generates an image based on the provided text.</p>
                </div>
                    ...
                    <Table>
                      ...
                      <TableBody>
                        <TableRow>
                          ...
                          <TableCell>The text that will be used to generate the image</TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <p>
                    The API returns an image directly. If successful, the response will be an image file with the
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  <Button
                    ...
                    onClick={() => copyToClipboard("GET https://api.vtxgroup.my.id/api/v1/brat?text=Love")}
                  >
                    <Copy className="h-4 w-4" />
                  </Button>
                  <pre className="bg-muted p-4 rounded-md overflow-x-auto">
                    <code className="text-sm">GET https://api.vtxgroup.my.id/api/v1/brat?text=Love</code>
                  </pre>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  <Button
                    ...
                    onClick={() =>
                      copyToClipboard(
                        '<img src="https://api.vtxgroup.my.id/api/v1/brat?text=Love" alt="Generated Brat Image" />',
                      )
                    }
                  >
                    <Copy className="h-4 w-4" />
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  <Button
                    ...
                    className="absolute top-2 right-2 h-8 w-8"
                    onClick={() =>
                      copyToClipboard(`fetch('https://api.vtxgroup.my.id/api/v1/brat?text=Love')
  .then(response => {
    if (!response.ok) {
  ...
  .catch(error => console.error('Error:', error));`)
                  ...
                  <pre className="bg-muted p-4 rounded-md overflow-x-auto">
                    <code className="text-sm">
                      {`fetch('https://api.vtxgroup.my.id/api/v1/brat?text=Love')
  .then(response => {
    if (!response.ok) {
      return response.json().then(err => Promise.reject(err));
    }
  ...
  .catch(error => console.error('Error:', error));`}
              ...
              <div className="mt-6">
                ...
                <ul className="space-y-3 mt-2">
                  ...
                  <li className="flex items-start">
                    <ArrowRight className="h-5 w-5 mr-2 mt-0.5 text-primary flex-shrink-0" />
                    <span>
                      The API directly fetches and returns the image, making it efficient for real-time requests.
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <DocNavigation
            ...
            apiUrl="https://api.vtxgroup.my.id/api/v1/brat?text=Love"
          />
        </motion.div>
      </div>
    </div>
