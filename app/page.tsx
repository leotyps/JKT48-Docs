    ...
    <div className="flex flex-col min-h-screen bg-gray-950">
      <div className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-b from-gray-950 via-gray-950 to-gray-950/90 z-10"></div>
        ...
        <section className="w-full py-16 md:py-24 lg:py-32 bg-gray-950">
          <div className="container px-4 md:px-6">
            <motion.div 
              ...
              variants={fadeIn}
            >
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl text-white">Choose a Category</h2>
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              ...
              >
                ...
                <h2 className="text-3xl font-bold tracking-tight md:text-4xl text-white">Easy Integration</h2>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center">
                    ...
                    <span className="text-gray-300">JSON response format</span>
                  </li>
                  <li className="flex items-center">
                    <div className="mr-3 h-5 w-5 rounded-full bg-primary/20 flex items-center justify-center">
                      <div className="h-2.5 w-2.5 rounded-full bg-primary"></div>
              ...
              >
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-xl p-5 md:p-6 shadow-xl overflow-x-auto">
                  ...
                  <pre className="bg-gray-950 p-4 md:p-5 rounded-md overflow-x-auto text-xs md:text-sm whitespace-pre-wrap md:whitespace-pre">
                    <code className="text-sm">
                      <span className="text-gray-500">$</span> <span className="text-blue-400">curl</span> -X GET
